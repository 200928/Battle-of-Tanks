...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    private int enemyTankSize = new Random().nextInt(2) + 5;
    ...
    public MyPanel() {
        ...
        for (int i = 0; i < enemyTankSize; i++) {
            int x = new Random().nextInt(800) + 50;
...
//            if (ourTank.shot == null || !ourTank.shot.isLive()) {
...
//            }
    ...
    public void hitEnemyTank(Vector<Shot> vector, Vector<EnemyTank> enemyTanks) {
